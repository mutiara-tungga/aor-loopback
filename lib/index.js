...
exports.default = function (apiUrl) {
            ...
            case _types.GET_MANY:
                {
                    ...
                    url = apiUrl + '/' + resource + '?' + (0, _fetch.queryParameters)({ filter: JSON.stringify(_query) });
                    break;
                }
            case _types.GET_MANY_REFERENCE:
                {
                    ...
                    url = apiUrl + '/' + resource + '?' + (0, _fetch.queryParameters)({ filter: JSON.stringify(_query2) });
                    break;
                }
            case _types.UPDATE:
                url = apiUrl + '/' + resource + '/' + params.id;
    ...
    var convertHTTPResponseToREST = function convertHTTPResponseToREST(response, type, resource, params) {
        ...
        switch (type) {
            ...
            case _types.CREATE:
                return { data: _extends({}, params.data, { id: json.data.id }) };
            default:
